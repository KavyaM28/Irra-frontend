      ...
      <section className="marquee-section">
        <div className="marquee-track">
          {['img1', 'img2', 'img3', 'img4', 'img5', 'img6', 'img7', 'img8'].map((img, i) => (
            <img key={i} src={`/images/${img}.jpg`} alt={`Slide ${i + 1}`} />
          ))}
          {['img1', 'img2', 'img3', 'img4', 'img5', 'img6', 'img7', 'img8'].map((img, i) => (
            <img key={i + 100} src={`/images/${img}.jpg`} alt={`Slide ${i + 9}`} />
          ))}
        </div><br /><br />
      ...
      <section className="service-detail">
        <div className="service-block">
          ...
          <div className="text">
            ...
            <p>We create fully styled, move-in ready spaces that bring your business to life - designed with elegance, functionality, and purpose.</p>
          </div>
        </div><br />
        ...
        <div className="service-block reverse">
          ...
          <div className="text">
            ...
            <p>From quiet focus zones to collaborative hubs - we design workspaces that move your business forward.</p>
          </div>
        </div><br />
        ...
        <div className="service-block">
          ...
          <div className="text">
            ...
            <p>We design homes that blend beauty with comfort - spaces that reflect your lifestyle, your taste, and your story.</p>
          </div>
        </div>
      </section>
